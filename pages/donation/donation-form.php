            ...
            <div class="card px-4 pb-4">
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        ...
                        <p style="text-align: justify; margin: 0 0 0 50px; color: black;">
                    ...
                    <div class="col-md-6">
                        <h3>Thank You!</h3>
                        <p style="text-indent: justify; margin: 0 30px; color: black; font-size: 20px; line-height: 1.6;">
                            To successfully organize events and initiatives,
                            we rely on the generous contributions from individuals and organization like yours.
